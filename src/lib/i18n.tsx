...
const strings = {
  ...
  en: {
    ...
    storyP1:
      "This is not a lottery. This is a family. The ʿAḍud. One dollar, and you become ʿAḍīd. Do not join to take. Join because you are someone's arm.",
    storyP2:
