...
const strings = {
  ar: {
    ...
    cardCheckoutHint: "بطاقة أو Apple Pay أو Google Pay عبر Stripe.",
  ...
  en: {
    ...
    createAccountCta: "Create account · $1",
    ...
    accountFlow1: "1. Pick a unique username and create your account.",
    accountFlow2: "2. Pay $1 with card, Apple Pay, or Google Pay (Stripe test or simulator).",
    accountFlow3: "3. Your username appears on the ledger and your desk unlocks.",
